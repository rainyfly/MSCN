...
class SubSet140DataSet(data.Dataset):
    ...
    def _scan(self):
        if self.train:
            dataset = h5py.File('/data/chenjian/experiment/data/subset140.h5','r')
            images_hr = dataset['label']
            images_lr = dataset['train']
        else:
            dataset = h5py.File('/data/chenjian/experiment/data/subset140Vad.h5','r')
            images_hr = dataset['label']
            images_lr = dataset['train']
