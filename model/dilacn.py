...
class MSCN_Block(nn.Module):
    def __init__(self, depth):
        ...
        self.conv_5_1 = nn.Conv2d(in_channels = channel, out_channels = channel, kernel_size = 3, stride = 1, padding = 2, dilation=2,bias = True)
        self.conv_5_2 = nn.Conv2d(in_channels = channel * 2, out_channels = channel, kernel_size = 3, stride = 1, padding = 2, dilation=2, bias = True)
