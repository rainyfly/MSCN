...
class MSRB_Block(nn.Module):
    def __init__(self):
        ...
        self.ca1 = CALayer(channel * 2)
        self.ca2 = CALayer(channel * 2)
    ...
    def forward(self, x):
        ...
        output_3_2 = self.ca1(output_3_2)
        output_5_2 = self.relu(self.conv_5_2(input_2))
        output_5_2 = self.ca2(output_5_2)
...
class MSRN_1_18(nn.Module):
    def __init__(self):
        super(MSRN_1_18, self).__init__()
