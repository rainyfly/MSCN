...
class MemNet(nn.Module):
    def __init__(self, in_channels, channels, num_memblock, num_resblock):
        ...
        self.feature_extractor = nn.Sequential(*[nn.Conv2d(1,256,kernel_size=4,stride=2, padding=1),
                        nn.PixelShuffle(2),
        ...
        self.reconstructor = nn.Sequential(nn.Conv2d(64,256,kernel_size=3,padding=1),nn.PixelShuffle(2),nn.Conv2d(64,3,kernel_size=3,padding=1))
