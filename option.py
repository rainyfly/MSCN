import argparse
import template
parser = argparse.ArgumentParser(description='set up argument for the process')
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/data/chenjian/experiment/data',
                    help='dataset root directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='RAISEDataSet',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='RAISEDataSet',
                    help='test dataset name')
parser.add_argument('--benchmark_noise', action='store_true',
                    help='use noisy benchmark sets')
parser.add_argument('--n_train', type=int, default=1960,
...
parser.add_argument('--model', default='DMSCN',
                    help='model name')
...
parser.add_argument('--test_every', type=int, default=15263,
