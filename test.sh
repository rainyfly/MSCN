...
CUDA_VISIBLE_DEVICES=5 python main.py --model mscn --save mscn --print_model --pre_train pretrain/mscn.pt --test_only --save_results --chop
#CUDA_VISIBLE_DEVICES=5 python main.py --model cadbn --save cadbn --print_model --pre_train pretrain/cadbn.pt --test_only --save_results --chop
